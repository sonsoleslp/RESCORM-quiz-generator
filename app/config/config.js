export let GLOBAL_CONFIG = {
  dev:{
    ...
    // locale: "es",
    adaptive:true,
    finish_screen: true, //(window.config && window.config.finish_screen !== undefined) ? window.config.finish_screen : true,
    scorm:{
  ...
  production:{
    ...
    available_locales:["en", "es"],
    adaptive:true,
    finish_screen: true,//git co(window.config && window.config.finish_screen !== undefined) ? window.config.finish_screen : true,
    scorm:{
      completion_threshold:0.5,
      score_threshold:0.6,
    },
